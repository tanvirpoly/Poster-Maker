...
.cv-head{background:#00a327; width: 100%; height: 120px; padding: 0px}


.photo{background: #C7C9C7; height: 380px;}

.center{text-align: center; padding: 8px 470px 0px 0px; }

.cv-content{width: 70%; background: #FAF2EF; padding:30px 10px 10px 20px;}
...
.body-item{ padding-left: 305px; color: #FFFFFF }

.body-head{font-size: 17pt; font-family: algerian}

.body-details{padding:0 0 0 44px; }

.detail-item,.info-item{ margin-top: 8px}
...
<!-- Start typing Part -->
	...
	<div class="well well-sm" style="width: 50%; margin-left: 8px;float: right;" >
...
<div id="cvUploadDialog" style="z-index: 1;position: absolute;width: 100%;display: none;">
 ...
 <button class="pull-right btn btn-success" style="position: fixed;right: 22px;bottom: 22px;box-shadow: 2px 2px 11px black" id="download">Finish and Download CV</button>
</body>
</html>
<script>
	$(document).ready(function()
