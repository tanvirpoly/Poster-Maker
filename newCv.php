...
<div class="dashboard treb " style="background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;">
	...
	<ul>
		...
		<a href="newCv.php"><li style="background:#739099"><i class="fa fa-edit fa-fw"></i>Build New Poster</li></a>
...
<div style=";margin-left: 18%;padding-top: 122px" class="flex">
  ...
  <img src="photo/theme1.png" class="img-responsive"><br><br>
   <a href="theme1.php"><button class="btn btn-primary  btn-block">Get Start a Poster</button></a>
	</div>
...
<!-- 	<div class="well well-sm" id="mydiv" style="width: 47%;margin-left: 33px;background-color: rgba(0, 0, 0, 0.4);  opacity: inherit">
      ...
      <a href="theme2.php"><button class="btn btn-primary  btn-block">Get Start a Poster</button></a>
