...
.body-item{ padding-left: 330px; color: #FFFFFF }
		...
		<div class="cvBody pull-left" id="example">
				...
				<div class="photo center one ">
					...
					<span id="picSpan" class="two">
						<img id="image_preview" src="photo/old_user.png" width="120px" style="margin: auto; padding-top: 2px">
					</span><br>
              ...
              <!-- Job Title -->
				 ...
				 <div class="center four">
					<span style="color: white;" id="cvname">Job Title</span>
				 </div>

				   <!-- Poster Title -->

				 <div class="center five">
					<span style="color: white;" id="cvname">Poster Title</span>
				 </div>
				...
				<div class="about-tab fontTreb">
					...
					<div class="about-details">
						<ul>
							...
							<li id="cvaddress">Handle petty cash, cash books, Ledger, and all accounts.</li>
						</ul>
					</div>
			...
			<!--  		<div class="about-head"><i class="fa fa-address-book-o fa-fw"></i>REQUIREMENT:</div>
					...
					<div class="about-details" >
						<ul>
							...
							<li id="cvskill2" style="display: none;">Preferred Professional Certification CA (CC)</li>
							<li id="cvskill3" style="display: none;">Excellent Communication Skills in MS word, excel PowerPoint</li>
					...
					<div class="body-details fontTreb" id="cvExp1">
						<div class="detail-item">
							<div class="detail-item-head" id="cvExp1">
								<span id="cvExp1name">Salary: 50k-60k</span>, 
...
<!-- Start typing Part -->
	...
	<div class="well well-sm" style="width: 45%; margin-left: 8px;float: right;" >
		<ul class="nav nav-tabs">
		  ...
		  <li><a data-toggle="tab" href="#menu-cvDesign">Poster Design</a></li>
		</ul>
...
<!--  <button class="pull-right btn btn-success" style="position: fixed;right: 22px;bottom: 22px;box-shadow: 2px 2px 11px black" id="download">Finish and Download CV</button> <br> <br> -->
  ...
  <button class="pull-right btn btn-success" style="position: fixed;right: 22px;bottom: 22px;box-shadow: 2px 2px 11px black" id="dl-png">Finish and Download CV</button>
